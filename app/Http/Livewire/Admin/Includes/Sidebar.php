    ...
    public function mount()
    {
        ...
        $this->links = [
            ...
            [
                ...
                'is_active' => in_array(request()->path(), ['dashboard/users', 'dashboard/users/create', 'dashboard/levels', 'dashboard/verifications', 'dashboard/users/transactions']),
                'childs' => [
                    ['text' => __('messages.t_browse_all'), 'href' => "$dashboard/users", 'is_active' => request()->path() === 'dashboard/users'],
                    ['text' => __('messages.t_create_new'), 'href' => "$dashboard/users/create", 'is_active' => request()->path() === 'dashboard/users/create'],
                    ['text' => __('messages.t_levels'), 'href' => "$dashboard/levels", 'is_active' => request()->path() === 'dashboard/levels'],
                    ['text' => __('messages.t_verifications'), 'href' => "$dashboard/verifications", 'is_active' => request()->path() === 'dashboard/verifications'],
                    ['text' => __('messages.t_transactions'), 'href' => "$dashboard/users/transactions", 'is_active' => request()->path() === 'dashboard/users/transactions'],
                ],
            ],
            ...
            [
                ...
                'is_active' => in_array(request()->path(), ['dashboard/withdrawals']),
                'childs' => [
                    ['text' => __('messages.t_withdrawals_history'), 'href' => "$dashboard/withdrawals", 'is_active' => request()->path() === 'dashboard/withdrawals']
                ],
            ],
            ...
            [
                ...
                'is_active' => in_array(request()->path(), ['dashboard/portfolios']),
                'childs' => [
                    ['text' => __('messages.t_browse_all'), 'href' => "$dashboard/portfolios", 'is_active' => request()->path() === 'dashboard/portfolios']
                ],
            ],
            ...
            [
                ...
                'is_active' => in_array(request()->path(), ['dashboard/gigs']),
                'childs' => [
                    ['text' => __('messages.t_browse_all'), 'href' => "$dashboard/gigs", 'is_active' => request()->path() === 'dashboard/gigs']
                ],
            ],
            ...
            [
                ...
                'is_active' => in_array(request()->path(), ['dashboard/invoices']),
                'childs' => [
                    ['text' => __('messages.t_browse_all'), 'href' => "$dashboard/invoices", 'is_active' => request()->path() === 'dashboard/invoices']
                ],
            ],
            ...
            [
                ...
                'is_active' => in_array(request()->path(), ['dashboard/orders']),
                'childs' => [
                    ['text' => __('messages.t_browse_all'), 'href' => "$dashboard/orders", 'is_active' => request()->path() === 'dashboard/orders']
                ],
            ],
            ...
            [
                ...
                'is_active' => in_array(request()->path(), ['dashboard/refunds']),
                'childs' => [
                    ['text' => __('messages.t_browse_all'), 'href' => "$dashboard/refunds", 'is_active' => request()->path() === 'dashboard/refunds']
                ],
            ],
            ...
            [
                ...
                'is_active' => in_array(request()->path(), ['dashboard/reviews']),
                'childs' => [
                    ['text' => __('messages.t_browse_all'), 'href' => "$dashboard/reviews", 'is_active' => request()->path() === 'dashboard/reviews']
                ],
            ],
            ...
            [
                ...
                'is_active' => in_array(request()->path(), ['dashboard/projects', 'dashboard/projects/bids', 'dashboard/projects/categories', 'dashboard/projects/skills', 'dashboard/projects/plans', 'dashboard/projects/subscriptions', 'dashboard/projects/settings']),
                'childs' => [
                    ['text' => __('messages.t_browse_all'), 'href' => "$dashboard/projects", 'is_active' => request()->path() === 'dashboard/projects'],
                    ['text' => __('messages.t_bids'), 'href' => "$dashboard/projects/bids", 'is_active' => request()->path() === 'dashboard/projects/bids'],
                    ['text' => __('messages.t_categories'), 'href' => "$dashboard/projects/categories", 'is_active' => request()->path() === 'dashboard/projects/categories'],
                    ['text' => __('messages.t_skills'), 'href' => "$dashboard/projects/skills", 'is_active' => request()->path() === 'dashboard/projects/skills'],
                    ['text' => __('messages.t_plans'), 'href' => "$dashboard/projects/plans", 'is_active' => request()->path() === 'dashboard/projects/plans'],
                    ['text' => __('messages.t_subscriptions'), 'href' => "$dashboard/projects/subscriptions", 'is_active' => request()->path() === 'dashboard/projects/subscriptions'],
                    ['text' => __('messages.t_settings'), 'href' => "$dashboard/projects/settings", 'is_active' => request()->path() === 'dashboard/projects/settings'],
                ],
            ],
            ...
            [
                ...
                'is_active' => in_array(request()->path(), ['dashboard/offers']),
                'childs' => [
                    ['text' => __('messages.t_browse_all'), 'href' => "$dashboard/offers", 'is_active' => request()->path() === 'dashboard/offers']
                ],
            ],
            ...
            [
                ...
                'is_active' => in_array(request()->path(), ['dashboard/categories', 'dashboard/subcategories']),
                'childs' => [
                    ['text' => __('messages.t_categories'), 'href' => "$dashboard/categories", 'is_active' => request()->path() === 'dashboard/categories'],
                    ['text' => __('messages.t_subcategories'), 'href' => "$dashboard/subcategories", 'is_active' => request()->path() === 'dashboard/subcategories']
                ],
            ],
            ...
            [
                ...
                'is_active' => in_array(request()->path(), ['dashboard/reports/users', 'dashboard/reports/gigs', 'dashboard/reports/projects', 'dashboard/reports/bids']),
                'childs' => [
                    ['text' => __('messages.t_users'), 'href' => "$dashboard/reports/users", 'is_active' => request()->path() === 'dashboard/reports/users'],
                    ['text' => __('messages.t_gigs'), 'href' => "$dashboard/reports/gigs", 'is_active' => request()->path() === 'dashboard/reports/gigs'],
                    ['text' => __('messages.t_projects'), 'href' => "$dashboard/reports/projects", 'is_active' => request()->path() === 'dashboard/reports/projects'],
                    ['text' => __('messages.t_bids'), 'href' => "$dashboard/reports/bids", 'is_active' => request()->path() === 'dashboard/reports/bids'],
                ],
            ],
            ...
            [
                ...
                'is_active' => in_array(request()->path(), ['dashboard/conversations']),
                'childs' => [
                    ['text' => __('messages.t_browse_all'), 'href' => "$dashboard/conversations", 'is_active' => request()->path() === 'dashboard/conversations']
                ],
            ],
            ...
            [
                ...
                'is_active' => in_array(request()->path(), ['dashboard/blog', 'dashboard/blog/comments', 'dashboard/blog/create', 'dashboard/blog/settings']),
                'childs' => [
                    ['text' => __('messages.t_browse_articles'), 'href' => "$dashboard/blog", 'is_active' => request()->path() === 'dashboard/blog'],
                    ['text' => __('messages.t_comments'), 'href' => "$dashboard/blog/comments", 'is_active' => request()->path() === 'dashboard/blog/comments'],
                    ['text' => __('messages.t_create_article'), 'href' => "$dashboard/blog/create", 'is_active' => request()->path() === 'dashboard/blog/create'],
                    ['text' => __('messages.t_blog_settings'), 'href' => "$dashboard/blog/settings", 'is_active' => request()->path() === 'dashboard/blog/settings'],
                ],
            ],
            ...
            [
                ...
                'is_active' => in_array(request()->path(), ['dashboard/support']),
                'childs' => [
                    ['text' => __('messages.t_messages'), 'href' => "$dashboard/support", 'is_active' => request()->path() === 'dashboard/support']
                ],
            ],
            ...
            [
                ...
                'is_active' => in_array(request()->path(), ['dashboard/newsletter', 'dashboard/newsletter/settings']),
                'childs' => [
                    ['text' => __('messages.t_browse_all'), 'href' => "$dashboard/newsletter", 'is_active' => request()->path() === 'dashboard/newsletter'],
                    ['text' => __('messages.t_settings'), 'href' => "$dashboard/newsletter/settings", 'is_active' => request()->path() === 'dashboard/newsletter/settings'],
                ],
            ],
            ...
            [
                ...
                'is_active' => in_array(request()->path(), ['dashboard/languages', 'dashboard/languages/create']),
                'childs' => [
                    ['text' => __('messages.t_browse_all'), 'href' => "$dashboard/languages", 'is_active' => request()->path() === 'dashboard/languages'],
                    ['text' => __('messages.t_create_new'), 'href' => "$dashboard/languages/create", 'is_active' => request()->path() === 'dashboard/languages/create']
                ],
            ],
            ...
            [
                ...
                'is_active' => in_array(request()->path(), ['dashboard/pages', 'dashboard/pages/create']),
                'childs' => [
                    ['text' => __('messages.t_browse_all'), 'href' => "$dashboard/pages", 'is_active' => request()->path() === 'dashboard/pages'],
                    ['text' => __('messages.t_create_new'), 'href' => "$dashboard/pages/create", 'is_active' => request()->path() === 'dashboard/pages/create'],
                ],
            ],
            ...
            [
                ...
                'is_active' => in_array(request()->path(), ['dashboard/countries', 'dashboard/countries/create']),
                'childs' => [
                    ['text' => __('messages.t_browse_all'), 'href' => "$dashboard/countries", 'is_active' => request()->path() === 'dashboard/countries'],
                    ['text' => __('messages.t_create_new'), 'href' => "$dashboard/countries/create", 'is_active' => request()->path() === 'dashboard/countries/create'],
                ],
            ],
            ...
            [
                ...
                'is_active' => in_array(request()->path(), ['dashboard/services/payment', 'dashboard/services/recaptcha']),
                'childs' => [
                    ['text' => __('dashboard.t_payment_gateways'), 'href' => "$dashboard/services/payment", 'is_active' => request()->path() === 'dashboard/services/payment'],
                    ['text' => __('messages.t_recaptcha'), 'href' => "$dashboard/services/recaptcha", 'is_active' => request()->path() === 'dashboard/services/recaptcha'],
            ...
            [
                ...
                'is_active' => in_array(request()->path(), [
                ...
                'childs' => [
                    ['text' => __('messages.t_general_settings_sidebar'), 'href' => "$dashboard/settings/general", 'is_active' => request()->path() === 'dashboard/settings/general'],
                    ['text' => __('messages.t_appearance_settings_sidebar'), 'href' => "$dashboard/settings/appearance", 'is_active' => request()->path() === 'dashboard/settings/appearance'],
                    ['text' => __('messages.t_currency_settings_sidebar'), 'href' => "$dashboard/settings/currency", 'is_active' => request()->path() === 'dashboard/settings/currency'],
                    ['text' => __('messages.t_auth_settings_sidebar'), 'href' => "$dashboard/settings/auth", 'is_active' => request()->path() === 'dashboard/settings/auth'],
                    ['text' => __('messages.t_live_chat_settings_sidebar'), 'href' => "$dashboard/settings/chat", 'is_active' => request()->path() === 'dashboard/settings/chat'],
                    ['text' => __('messages.t_commission_settings_sidebar'), 'href' => "$dashboard/settings/commission", 'is_active' => request()->path() === 'dashboard/settings/commission'],
                    ['text' => __('messages.t_footer_settings_sidebar'), 'href' => "$dashboard/settings/footer", 'is_active' => request()->path() === 'dashboard/settings/footer'],
                    ['text' => __('messages.t_media_settings_sidebar'), 'href' => "$dashboard/settings/media", 'is_active' => request()->path() === 'dashboard/settings/media'],
                    ['text' => __('messages.t_publish_settings_sidebar'), 'href' => "$dashboard/settings/publish", 'is_active' => request()->path() === 'dashboard/settings/publish'],
                    ['text' => __('messages.t_security_settings_sidebar'), 'href' => "$dashboard/settings/security", 'is_active' => request()->path() === 'dashboard/settings/security'],
                    ['text' => __('messages.t_seo_settings_sidebar'), 'href' => "$dashboard/settings/seo", 'is_active' => request()->path() === 'dashboard/settings/seo'],
                    ['text' => __('messages.t_smtp_settings_sidebar'), 'href' => "$dashboard/settings/smtp", 'is_active' => request()->path() === 'dashboard/settings/smtp'],
                    ['text' => __('messages.t_hero_section'), 'href' => "$dashboard/settings/hero", 'is_active' => request()->path() === 'dashboard/settings/hero'],
                    ['text' => __('messages.t_withdrawal_settings_sidebar'), 'href' => "$dashboard/settings/withdrawal", 'is_active' => request()->path() === 'dashboard/settings/withdrawal'],
                ],
            ],
            ...
            [
                ...
                'is_active' => in_array(request()->path(), ['dashboard/system/crontab', 'dashboard/system/logs', 'dashboard/system/cache', 'dashboard/system/maintenance']),
                'childs' => [
                    ['text' => __('messages.t_cron_jobs'), 'href' => "$dashboard/system/crontab", 'is_active' => request()->path() === 'dashboard/system/crontab'],
                    ['text' => __('messages.t_logs'), 'href' => "$dashboard/system/logs", 'is_active' => request()->path() === 'dashboard/system/logs'],
                    ['text' => __('messages.t_cache'), 'href' => "$dashboard/system/cache", 'is_active' => request()->path() === 'dashboard/system/cache'],
                    ['text' => __('messages.t_maintenance'), 'href' => "$dashboard/system/maintenance", 'is_active' => request()->path() === 'dashboard/system/maintenance'],
                ],
            ]
