...
} elseif ($_instance->childHasBeenRendered('MpLW0cM')) {
    $componentId = $_instance->getRenderedChildComponentId('MpLW0cM');
    $componentTag = $_instance->getRenderedChildComponentTagName('MpLW0cM');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('MpLW0cM');
} else {
    $response = \Livewire\Livewire::mount('admin.includes.header');
    $html = $response->html();
    $_instance->logRenderedChild('MpLW0cM', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('Rb9rrVn')) {
    $componentId = $_instance->getRenderedChildComponentId('Rb9rrVn');
    $componentTag = $_instance->getRenderedChildComponentTagName('Rb9rrVn');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('Rb9rrVn');
} else {
    $response = \Livewire\Livewire::mount('admin.includes.sidebar');
    $html = $response->html();
    $_instance->logRenderedChild('Rb9rrVn', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH D:\xampp8.2\htdocs\riverr\resources\views/livewire/admin/layout/app.blade.php ENDPATH**/ ?>