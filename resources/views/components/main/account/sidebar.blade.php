...
<nav class="w-full {{ $class ? $class : '' }}">
    ...
    @php
        $link_active_class = 'bg-[#B0FFE8] border-[#0C7F4C] text-[#0C7F4C] dark:text-white hover:bg-[#B0FFE8] hover:text-[#0C7F4C]';
        ...
        $icon_active_class = 'text-[#0C7F4C] dark:text-gray-50 group-hover:text-[#0C7F4C] dark:group-hover:text-white';
