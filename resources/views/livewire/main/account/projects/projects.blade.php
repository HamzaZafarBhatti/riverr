            ...
            <div class="lg:flex lg:items-center lg:justify-between">
                ...
                <div class="mt-5 flex justify-between lg:mt-0 lg:ltr::ml-4 lg:rtl:mr-4">
                    ...
                    @if (settings('projects')->who_can_post === 'both' || settings('projects')->who_can_post === auth()->user()->account_type)
                        <span class="">
                            <a href="{{ url('post/project') }}" class="inline-flex items-center rounded border border-transparent bg-[#0C7F4D] px-4 py-3 text-lg font-medium capitalize text-white hover:bg-[#0C7F4D] focus:outline-none focus:ring-2 focus:ring-opacity-25 focus:ring-[#0C7F4D] tracking-widest">
