        ...
        <nav class="relative container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 justify-between items-center h-20 flex">
            ...
            <div class="w-full hidden lg:block">   
                <div class="relative max-w-md" x-data="{ open: false }">
                    ...
                    {{-- Search button --}}
                    <button type="button" wire:click="enter" class="flex items-center justify-center absolute top-0 ltr:right-0 rtl:left-0 p-2.5 text-white bg-[#00966B] hover:bg-[#00966B] h-10 ltr:rounded-r rtl:rounded-l border border-[#00966B] hover:border-[#00966B]">
